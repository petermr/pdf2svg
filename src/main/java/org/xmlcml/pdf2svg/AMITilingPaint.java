 ...
 * @author John Hewson
 */
class AMITilingPaint implements Paint
{
    private static final Log LOG = LogFactory.getLog(AMITilingPaint.class);
     ...
     */
    AMITilingPaint(PageDrawer drawer, PDTilingPattern pattern, AffineTransform xform)
            throws IOException
    {
     ...
     * @throws java.io.IOException if something goes wrong while drawing the pattern
     */
    AMITilingPaint(PageDrawer drawer, PDTilingPattern pattern, PDColorSpace colorSpace,
