...
public class PConstants {
	...
	public static final String ORG_NAME = "contentmine";
//	public static final String PDF2SVG_ROOT0 = PConstants.class.getPackage().toString();
//	public static final String PDF2SVG_ROOT = PDF2SVG_ROOT0.substring(0, PDF2SVG_ROOT0.lastIndexOf('.'));
	public static final String PDF2SVG_ROOT = "org/contentmine/pdf2svg";
	public static final String CODEPOINT_ROOT = "org/xmlcml/pdf2svg";
