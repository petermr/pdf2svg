...
public class TexCharacterSet {
	...
	public final static String LATEX2UNICODE = CodePointSet.CODEPOINT_DIR + "/latex/unimathsymbols.txt";
	public final static String LATEX2UNICODE_XML = CodePointSet.CODEPOINT_DIR + "/latex/unimathsymbols.xml";
