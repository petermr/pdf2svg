...
import org.contentmine.pdf2svg.util.Util_1_8;
...
//	private static double eps = 0.001;
	...
	private void init() {
        ...
        StyleAttributeFactory.convertOldStyleAttributesToCSSAndDelete(background);
...
//			LOG.warn("Creating new SVG - probably should have been done elsewhere");
	...
	public void createPathAndClearPrimitiveList() {
		...
		addFillStroke(path);
		if (currentPathG == null) {
			LOG.error("*********NULL currentPathG*********");
//			return;
		} else {
